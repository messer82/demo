...
public class AccountRepositoryImplTest {
    ...
    @Before
    public void setup() {
        account1 = Account.builder().accountId(1).userId(1).accountNumber("RO455454").balance(BigDecimal.valueOf(4545)).build();
        account2 = Account.builder().accountId(2).userId(2).accountNumber("RO784886").balance(BigDecimal.valueOf(4532)).build();
