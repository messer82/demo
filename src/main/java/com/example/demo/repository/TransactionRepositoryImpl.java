...
public class TransactionRepositoryImpl implements TransactionRepository {
    ...
    public List<Transaction> findAll() {
        String sqlQuery = "SELECT transaction_id, account_id, destination_account, amount, transaction_type, transaction_date FROM transactions";
    ...
    public List<Transaction> findByAccountId(int id) {
        String sqlQuery = "SELECT transaction_id, account_id, destination_account, amount, transaction_type, transaction_date FROM transactions WHERE account_id = ?";
        RowMapper<Transaction> transactionRowMapper = getTransactionRowMapper();
    ...
    public Transaction findById(int id) {
        String sqlQuery = "SELECT transaction_id, account_id, destination_account, amount, transaction_type, transaction_date FROM transactions WHERE transaction_id = ?";
        return jdbcTemplate.queryForObject(sqlQuery, getTransactionRowMapper(), id);
    }

    @Override
    public Transaction save(Transaction transaction) {
        String sqlQuery = "INSERT INTO transactions (account_id, destination_account, amount, transaction_type) VALUES (?, ?, ?, ?)";
